...
Pod::Spec.new do |spec|
  ...
  # Or just: spec.author    = "weijian"
  # spec.authors            = { "weijian" => "18629702013@163.com" }
  # spec.social_media_url   = "https://twitter.com/weijian"
  ...
  spec.source_files  = "TDCGMFramework/TDFramework.framework/Headers/*.{h,m,swift}"
